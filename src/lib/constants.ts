...
export default {
	...
	summary: `
		<ul>
			<li>☑️ Frontend Engineer with <span class="text-foreground">${differenceInYears(new Date(), parseDate(firstJobDateStart))}+ years</span> of experience in building high-performance web applications.</li>
	...
	skills: [
		...
		},
		{
			title: 'State',
			Icon: Database,
			items: ['Redux', 'Zustand', 'React Query', 'Apollo Client']
		},
		{
			title: 'UI/UX',
			Icon: Palette,
		...
		},
		{
			title: 'Tools',
			Icon: Wrench,
			items: ['REST & GraphQL', 'AWS & Jest', 'Git & CI/CD', 'Webpack & Vite']
		}
	],
	experience: [
		{
			...
			dateEnd: 'Present',
			achievements: [
				'Led the frontend development of a <span class="text-foreground">help platform</span>, enabling users to access and manage support resources, knowledge bases, and chat support.',
				'Built key features using <span class="text-foreground">Next.js</span> and <span class="text-foreground">GraphQL</span>, including content management systems, search functionality, and user authentication.',
				'Enhanced UI/UX using <span class="text-foreground">Tailwind CSS</span>, <span class="text-foreground">Shadcn</span> and <span class="text-foreground">AWS S3</span> for cloud storage.',
				'Optimized application performance through <span class="text-foreground">code splitting</span>, <span class="text-foreground">image optimization</span>, and <span class="text-foreground">server-side rendering</span>.',
				'Worked closely with backend engineers, analysts, and product managers to align features with <span class="text-foreground">business objectives</span>.'
			]
		},
		{
		...
		},
		{
			...
			dateEnd: 'Jan 2023',
			achievements: [
				'Contributed to multiple <span class="text-foreground">SaaS projects</span> in the construction industry, including <a href="https://www.skema.ai">Skema AI</a>, <a href="https://www.youtube.com/watch?v=Km-pV_XXyWc&t=7s&ab_channel=Skema">Kreo Modular</a>, and <a href="https://www.mccarthy.com/siteshiftparking">SiteShift</a>.',
				'Developed complex features such as a report builder, SVG-based drawing tools, real-time chats, interactive cost tables, and 3D model integrations using <span class="text-foreground">React</span>, <span class="text-foreground">Redux</span>, <span class="text-foreground">Redux-Saga</span>, and <span class="text-foreground">Styled-Components</span>.',
