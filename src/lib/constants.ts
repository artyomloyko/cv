	...
	experience: [
		{
			...
			dateEnd: 'Present',
			achievements: [
				'Developed the frontend for a <span class="text-foreground">digital assistance platform</span>, providing users with personalized recommendations, educational materials, and access to services for navigating life challenges such as <span class="text-foreground">oncology, retirement, bullying, and domestic violence.</span>',
